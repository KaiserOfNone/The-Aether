...
public class ValkyrieRenderer extends MobRenderer<Valkyrie, ValkyrieRenderState, ValkyrieModel<ValkyrieRenderState>> {
    ...
    @Override
    public void extractRenderState(Valkyrie entity, ValkyrieRenderState reusedState, float partialTick) {
